...
const StatsVisualization = ({ statsA, statsB, labelA, labelB, color }) => {
  ...
  const tabItems = [
    ...
    },
    {
      ...
      children: <StatsHelp type='individual-to-group' />,
    },
  ];
...
const StatsHelp = ({ type }) => {
  if (type === 'individual-to-group') {
    return (
      <>
        <p>
        ...
        <br />
        <p>
          <b>Majorité</b>: le score est calculé à partir de la proportion de
          votes du député dans la même ligne que celle de la majorité
          présidentielle. Il s'agit donc de sa proximité avec la majorité
          présidentielle.
        </p>
        <br />
        <p>
          ...
          met à disposition un score de participation aux scrutins solennels,
          qui représentent les votes sur les projets de loi significatifs et
          fortement discutés.
        </p>
        <br />
        <p>
          <b>Participation (spécialité)</b>: le score est calculé à partir du
          taux de participation du député aux scrutins liés à son domaine de
